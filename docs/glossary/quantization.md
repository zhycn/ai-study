...
- **平滑量化（[SmoothQuant](https://github.com/mit-han-lab/smoothquant)）**：将激活值中的异常部分迁移到权重中
...
- **[GPTQ](https://github.com/AutoGPTQ/AutoGPTQ)**：基于逐层贪心优化的量化方法，精度高但量化速度慢
- **[AWQ](https://github.com/casper-hansen/AutoAWQ)（Activation-Aware Weight Quantization）**：通过激活值感知保护重要权重，推理速度优于 [GPTQ](https://github.com/AutoGPTQ/AutoGPTQ)
- **[QLoRA](https://arxiv.org/abs/2305.14314)**：结合 INT4 量化与 LoRA 微调，使在单张 GPU 上微调 65B 模型成为可能

:::info 信息
[QLoRA](https://arxiv.org/abs/2305.14314) 使用 4-bit NormalFloat（NF4）数据类型，这是一种信息论最优的 4 位量化格式，专门针对正态分布的权重设计。
:::
...
| [GPTQ](https://github.com/AutoGPTQ/AutoGPTQ)              | PTQ 变种 | 高   | 慢              | 快       | LLM INT4 量化          |
| [AWQ](https://github.com/casper-hansen/AutoAWQ)           | PTQ 变种 | 高   | 中              | 最快     | LLM INT4 部署          |
| [SmoothQuant](https://github.com/mit-han-lab/smoothquant) | PTQ 变种 | 高   | 中              | 快       | 处理激活异常值         |
| [QLoRA](https://arxiv.org/abs/2305.14314)                 | 微调结合 | 极高 | 中              | 中       | LLM 高效微调           |

:::tip 选择建议

- **快速验证**：选择 PTQ（INT8），几分钟即可完成
- **生产部署**：选择 QAT 或 [AWQ](https://github.com/casper-hansen/AutoAWQ)，精度损失最小
- **LLM 部署**：选择 [AWQ](https://github.com/casper-hansen/AutoAWQ) 或 [GPTQ](https://github.com/AutoGPTQ/AutoGPTQ)（INT4），兼顾精度和显存
- **LLM 微调**：选择 [QLoRA](https://arxiv.org/abs/2305.14314)，单卡即可微调大模型
  :::
...
### [llama.cpp](https://github.com/ggerganov/llama.cpp) 量化

[[llama.cpp](https://github.com/ggerganov/llama.cpp)](<https://github.com/ggerganov/[llama.cpp](https://github.com/ggerganov/llama.cpp)>) 是最流行的 LLM 量化推理框架，支持多种量化格式：
...
### [AWQ](https://github.com/casper-hansen/AutoAWQ)/[GPTQ](https://github.com/AutoGPTQ/AutoGPTQ) 算法

**[GPTQ](https://github.com/AutoGPTQ/AutoGPTQ)（GPT Quantization）**：

```python
# Auto[GPTQ](https://github.com/AutoGPTQ/AutoGPTQ) 使用示例
from auto_gptq import Auto[GPTQ](https://github.com/AutoGPTQ/AutoGPTQ)ForCausalLM, BaseQuantizeConfig
...
model = Auto[GPTQ](https://github.com/AutoGPTQ/AutoGPTQ)ForCausalLM.from_pretrained(
    "model_path",
...
**[AWQ](https://github.com/casper-hansen/AutoAWQ)（Activation-Aware Weight Quantization）**：
[AWQ](https://github.com/casper-hansen/AutoAWQ) 的核心思想是识别并保护对模型输出影响最大的权重（基于激活值统计），对这些权重使用更高精度量化。
...
- **量化微调**：在量化后进行少量轮数的微调（如 [QLoRA](https://arxiv.org/abs/2305.14314)）
...
- [[SmoothQuant](https://github.com/mit-han-lab/smoothquant) 论文](https://arxiv.org/abs/2211.10438) — 激活值感知的量化方法
- [[GPTQ](https://github.com/AutoGPTQ/AutoGPTQ) 论文](https://arxiv.org/abs/2210.17323) — 精确的 LLM 量化算法
- [[AWQ](https://github.com/casper-hansen/AutoAWQ) 论文](https://arxiv.org/abs/2306.00978) — 激活值感知的权重量化
- [[llama.cpp](https://github.com/ggerganov/llama.cpp) GitHub](<https://github.com/ggerganov/[llama.cpp](https://github.com/ggerganov/llama.cpp)>) — 流行的 LLM 量化推理框架
