...
### Hugging Face [DistilBERT](https://arxiv.org/abs/1910.01108)

[DistilBERT](https://arxiv.org/abs/1910.01108) 是知识蒸馏在 NLP 领域的经典应用，将 BERT 的参数量减少 40%，同时保持 97% 的性能。

```python
# [DistilBERT](https://arxiv.org/abs/1910.01108) 蒸馏配置要点
...
[DistilBERT](https://arxiv.org/abs/1910.01108) 的蒸馏策略：
...
### [TinyLlama](https://github.com/jzhang38/TinyLlama) 蒸馏流程
...
3. 考虑使用 [DeepSpeed](https://github.com/microsoft/DeepSpeed) 或 FSDP 进行分布式训练
   :::
...
- [[DistilBERT](https://arxiv.org/abs/1910.01108) 论文](https://arxiv.org/abs/1910.01108) — BERT 蒸馏的经典工作
- [Hinton 蒸馏论文](https://arxiv.org/abs/1503.02531) — 知识蒸馏原始论文
- [[TinyLlama](https://github.com/jzhang38/TinyLlama) 项目](<https://github.com/jzhang38/[TinyLlama](https://github.com/jzhang38/TinyLlama)>) — 小型 LLM 蒸馏实践
