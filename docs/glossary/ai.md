...
- **[Hugging Face Transformers](https://huggingface.co/docs/transformers/)**：开源模型库，提供数千个预训练模型
- **[LangChain](https://python.langchain.com/) / [LlamaIndex](https://docs.llamaindex.ai/)**：大模型应用开发框架
- **[vLLM](https://github.com/vllm-project/vllm) / [TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM)**：大模型推理优化框架
- **[Ollama](https://ollama.com/) / [LM Studio](https://lmstudio.ai/)**：本地大模型运行工具

### 云服务

- **OpenAI API**：GPT 系列模型的商业 API
- **[Google Vertex AI](https://cloud.google.com/vertex-ai)**：Google 的 AI 平台
- **[AWS SageMaker](https://aws.amazon.com/sagemaker/)**：Amazon 的机器学习平台
